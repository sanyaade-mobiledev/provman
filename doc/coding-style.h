 ...
 * from writing their plugins in C++.  For this reason, any header file
 * accessible to plugins, i.e., those located in the include folder, should
 * enclose any functions that it exports by
 *
 * \code
 * #ifdef __cplusplus
 * extern "C" {
 ...
 * <li>[PLUGIN-NAME] for changes to a specified plugin, PLUGIN-NAME to be
 * replaced by the name of the plugin, e.g., ofono.</li>
 * <li>[Tests] for changes to the test cases.</li>
 * </ul>
 *
